    ...
    <div class="container">
        ...
        <form action="{{ route('productionUpdateSubmit', $productions   ->ID) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input  value="{{$productions->Data}}" name="Date" style="width:300px;" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
            ...
            <a href="{{ route('productionShow')}}" class="btn btn-link">Back</a>
        </form>
    </div>
</body>
</html>